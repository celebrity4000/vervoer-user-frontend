  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginTop: '10%' , width: responsiveWidth(60), height: responsiveHeight(25), alignItems: 'center'}}>
        <Image
          source={images.EmailOTP}
          style={{width: '80%', height: '90%'}}
        />
      </View>
      <Text style={styles.title}>Verify Email ID</Text>
      <View style={{ width: responsiveWidth(65), marginTop: '5%' }}>
        <Text style={styles.subtitle}>Enter the Verification Code sent to your Email ID</Text>
      </View>
      <EmailOTPInput />
    </View>
  );
