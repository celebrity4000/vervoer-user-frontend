...
type RootStackParamList = {
  GarageScreen: {type: 'G' | 'L' | 'R'; title: string};
};
...
const ParkingSpotCard: React.FC<ParkingSpotCardProps> = ({
  ...
  const navigation = useNavigation<NavigationProp>(); // Typed useNavigation

  return (
    <TouchableOpacity
      style={[styles.parkingCard, selected && styles.selectedCard]}
      onPress={() => navigation.navigate('GarageScreen', {type, title})}>
